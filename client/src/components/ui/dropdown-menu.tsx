...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      data-inset={inset}
      className={cn(
        "relative flex cursor-default select-none items-center rounded-md px-3 py-2.5 text-sm outline-none transition-colors focus:bg-muted focus:text-primary data-disabled:pointer-events-none data-disabled:opacity-50 data-[inset=true]:pl-8",
        className
      )}
      {...props}
    />
